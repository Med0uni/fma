...
export const metadata: Metadata = {
  ...
  description: "The ultimate Arabic Football Manager community. Find tactics, wonderkids, guides, and connect with fellow managers.",
  keywords: ["Football Manager", "FM", "FM24", "FM Arabia", "Football Manager Arabic", "FM Tactics", "FM Wonderkids"],
