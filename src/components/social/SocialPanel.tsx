      ...
      <div className="space-y-4">
        {socialLinks.map((social, index) => (
          <motion.a
            ...
            className={`flex items-center gap-3 p-3 rounded-lg border hover:border-transparent ${social.color} hover:text-white transition-all group`}
          >
            <social.Icon className="h-5 w-5" />
            <span className="font-medium">{social.name}</span>
            <span className="ms-auto opacity-0 group-hover:opacity-100 transition-opacity">
